...
//saiu do laço
console.log(`Programa encerrado. Foi digitada uma palavra ou letra. A soma dos números pares é: ${somaPares} e a quantidade de números ímpares digitados é: ${quantidadeImp}`)